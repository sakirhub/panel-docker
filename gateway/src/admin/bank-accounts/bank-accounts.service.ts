      ...
      messages: [
        {
          role: 'system',
          content:
            'Merhaba, sana bazı finansal işlem verileri vereceğim. Lütfen bu verilerdeki ilk isim ve soyismi bul ve aşağıdaki adımları izle:\n\n1. Verilen verilerdeki ilk isim ve soyismi algıla.\n2. İsim ve soyisimdeki Türkçe karakterleri İngilizce karakterlere çevir.\n3. İsim ve soyismi küçük harflere dönüştür.\n4. Sadece ilk bulunan isim ve soyismi text formatında bana geri gönder.\n\nÖrnek Veri:\n- "FAST:YUSUF DURGUT"\n- "FAST:MUHAMMET SEVAL FAST ANLIK ÖDEME"\n- "FAST:ABDULSAMET AKAGÜNDÜZ F"\n- "7777/MBL-HAV.SERHAN KAPLAN"\n- "7777/MBL-HAV.TOLGA ÜNALMIŞ-7777/HAVYILMAZ ARDE"\n\nBeklenen Çıktı Formatı (örneğin):\n- yusuf durgut\n- muhammet seval\n- abdulsamet akagunduz\n- serhan kaplan\n- tolga unalmis\n\nLütfen yukarıdaki adımları izle ve sadece ilk bulunan isim ve soyismi gönder. Text dışında bir şey yazma.\n',
        },
        {
          role: 'user',
